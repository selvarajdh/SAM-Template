...
```bash
first-lambda$ sam build --use-container
```
...
```bash
first-lambda$ pip install -r tests/requirements.txt --user
# unit test
first-lambda$ python -m pytest tests/unit -v
# integration test, requiring deploying the stack first.
# Create the env variable AWS_SAM_STACK_NAME with the name of the stack we are testing
first-lambda$ AWS_SAM_STACK_NAME="first-lambda" python -m pytest tests/integration -v
```
